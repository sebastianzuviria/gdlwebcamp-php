    ...
    <form action="validar_registro.php" id="registro" class="registro" method="POST">
          ...
          <div id="sabado" class="contenido-dia">
            ...
            <div class="actividades-dia">
              ...
              <label><input type="checkbox" name="registro[]" id="conf_05" value="conf_05"><time>17:00</time>Los mejores
                lugares para entontrar trabajo</label>
          ...
          <div id="domingo" class="contenido-dia">
            ...
            <div class="actividades-dia">
              ...
              <label><input type="checkbox" name="registro[]" id="taller_11"
                  value="taller_11"><time>10:00</time>Laravel</label>
              <label><input type="checkbox" name="registro[]" id="taller_12" value="taller_12"><time>12:00</time>Crea tu
                propia API</label>
              <label><input type="checkbox" name="registro[]" id="taller_13"
                  value="taller_13"><time>14:00</time>JavaSCript y JQuery</label>
              <label><input type="checkbox" name="registro[]" id="taller_14" value="taller_14"><time>17:00</time>Creando
                Plantillas para WordPress</label>
              <label><input type="checkbox" name="registro[]" id="taller_15" value="taller_15"><time>19:00</time>Tiendas
                Virtuales enMAgento</label>
            </div>
            <div class="actividades-dia">
              <p>Conferencias:</p>
              <label><input type="checkbox" name="registro[]" id="conf_07" value="conf_07"><time>10:00</time>Como hacer
                Marketing en linea</label>
            ...
            <div class="actividades-dia">
              <p>Seminarios:</p>
              <label><input type="checkbox" name="registro[]" id="sem_03" value="sem_03"><time>10:00</time>Creando una App
      ...
      <div id="resumen" class="resumen">
        ...
        <div class="caja">
          <div class="extras">
            <div class="orden">
              <label for="camisa_evento">Camisa del evento $500<small>(promoción 15% de dto.)</small></label>
              <input type="number" min="0" id="camisa_evento" size="3" name="pedido_camisas" placeholder="0" value="0">
            </div>
            <!--Orden-->
            <div class="orden">
              <label for="etiquetas">Paquete de 10 etiquetas $150<small>(HTML5, CSS3, JavaScript.
                  Chrome)</small></label>
              <input type="number" min="0" id="etiquetas" size="3" name="pedido_etiquetas" placeholder="0" value="0">
            </div>
            <!--Orden-->
            <div class="orden">
            ...
            <input type="button" value="calcular" id="botonCalcular" class="boton">
          </div>
          <!--Extras-->
          ...
          <div class="total">
            ...
            <input type="submit" name="submit" value="pagar" id="botonPagar" class="boton">
          </div>
          <!--Total-->
        </div>
        <!--Caja-->
